angular.module("APP").controller("compareSecondCode", ['$rootScope', '$scope', '$http', '$q', '$filter', function ($rootScope, $scope, $http, $q, $filter) {

////////////////// code for action : compareSecondCode 

    $rootScope.compareSecondCode = function ($scope, param, $event) {
