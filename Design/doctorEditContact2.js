angular.module("APP").controller("doctorEditContact2", ['$rootScope', '$scope', '$http', '$q', '$filter', function ($rootScope, $scope, $http, $q, $filter) {

////////////////// code for action : saveDocContact2 

    $rootScope.doctorEditContact2 = function ($scope, param, $event) {
