angular.module("APP").controller("patientEditPassword", ['$rootScope', '$scope', '$http', '$q', '$filter',function($rootScope,$scope, $http,$q, $filter){

////////////////// code for action : savePersonPassword 

$rootScope.patientEditPassword = function($scope,param,$event){
	...
	url= 'http://172.16.201.212:8081/rest/api/v1/account/patient/password/edit';
