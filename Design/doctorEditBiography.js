angular.module("APP").controller("doctorEditBiography", ['$rootScope', '$scope', '$http', '$q', '$filter', function ($rootScope, $scope, $http, $q, $filter) {

////////////////// code for action : saveBiography 

    $rootScope.doctorEditBiography = function ($scope, param, $event) {
        $scope.saveBio = {};
