angular.module("APP").controller("doctorSignUp_MS4_01", ['$rootScope', '$scope', '$http', '$q', '$filter',function($rootScope,$scope, $http,$q, $filter){

////////////////// code for action : goToApprovePage 

$rootScope.doctorSignUp_MS4_01 = function($scope,param,$event){
	...
	$scope.callBack_10108 = function(data){
        ...
        if (data.mdc_error_code == -1) {
            ...
            $scope.navigateULR("DoctorSignUp","DSU_ConfirmInfo");
        }
	};
