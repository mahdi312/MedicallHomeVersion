angular.module("APP").controller("doctorSignUp_MS1", ['$rootScope', '$scope', '$http', '$q', '$filter', function ($rootScope, $scope, $http, $q, $filter) {

////////////////// code for action : getDoctorCode 

    $rootScope.doctorSignUp_MS1 = function ($scope, param, $event) {
