angular.module("APP").controller("doctorEditPrivacy", ['$rootScope', '$scope', '$http', '$q', '$filter',function($rootScope,$scope, $http,$q, $filter){

////////////////// code for action : saveDoctorPrivacy 

$rootScope.doctorEditPrivacy = function($scope,param,$event){
