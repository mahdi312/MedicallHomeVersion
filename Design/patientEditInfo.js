angular.module("APP").controller("patientEditInfo", ['$rootScope', '$scope', '$http', '$q', '$filter',function($rootScope,$scope, $http,$q, $filter){

////////////////// code for action : savePersonInfo2dashboard 

$rootScope.patientEditInfo = function($scope,param,$event){
