angular.module("APP").controller("getPersonImage", ['$rootScope', '$scope', '$http', '$q', '$filter', function ($rootScope, $scope, $http, $q, $filter) {

////////////////// code for action : getPersonImage 

    $rootScope.getPersonImage = function ($scope, param, $event) {
