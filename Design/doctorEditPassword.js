angular.module("APP").controller("doctorEditPassword", ['$rootScope', '$scope', '$http', '$q', '$filter', function ($rootScope, $scope, $http, $q, $filter) {

////////////////// code for action : changePassword 

    $rootScope.doctorEditPassword = function ($scope, param, $event) {
        $scope.editPass = {};
