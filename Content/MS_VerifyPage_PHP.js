app = angular.module("APP").controller("CtrlMS_VerifyPage_PHP", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$timeout){
...
$scope.makeDesign_272365 = function(param){ 
	 $rootScope.checkPatientSMS($scope,param); 
} 
