app = angular.module("APP").controller("CtrlDD_DoctorSecurity_Tab", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272537 = function(param){ 
	 $rootScope.doctorEditPassword($scope,param);
} 
