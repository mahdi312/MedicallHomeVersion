app = angular.module("APP").controller("CtrlMS_CellPhone", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272325 = function(param){ 
	 $rootScope.confirmNewUser($scope,param);
} 
