app = angular.module("APP").controller("CtrlDSU_AccountInformation", ['$rootScope', '$scope', '$http', '$q', '$filter', '$translate', '$mdToast', '$http', function ($rootScope, $scope, $http, $q, $filter, $translate, $mdToast) {
    ...
    $scope.makeDesign_272395 = function (param) {
        $rootScope.DSU_backToDocIDPage($scope, param);
    };

    $scope.makeDesign_272396 = function (param) {
        $rootScope.doctorSignUp_MS2($scope, param);
    };

    $scope.makeDesign_293331 = function (param) {
