app = angular.module("APP").controller("CtrlMS_VerifyPage_FT", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$timeout){
...
$scope.makeDesign_293353 = function(param){ 
	 $rootScope.compareVerifyCode($scope,param);
} ;

$scope.makeDesign_293354 = function(param){ 
	 $rootScope.goToChangeCellPhone($scope,param);
} ;
