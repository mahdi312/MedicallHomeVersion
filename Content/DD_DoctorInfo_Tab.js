app = angular.module("APP").controller("CtrlDD_DoctorInfo_Tab", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272510 = function(param){ 
	 $rootScope.doctorEditPersonInfo($scope,param);
} 
