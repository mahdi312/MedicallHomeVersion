app = angular.module("APP").controller("Ctrl190510", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293454 = function(param){ 
	 $rootScope.DD_changeToShowImage($scope,param);
} 

$scope.makeDesign_293453 = function(param){ 
