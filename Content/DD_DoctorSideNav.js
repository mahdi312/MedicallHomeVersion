app = angular.module("APP").controller("CtrlDD_DoctorSideNav", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293459 = function(param){ 
	 $rootScope.doctorSignOut($scope,param); 
} 
