app = angular.module("APP").controller("CtrlPD_PatientInfo_Tab", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_282665 = function(param){ 
	 $rootScope.patientEditInfo($scope,param);
} 

$scope.makeDesign_282791 = function(param){ 
	 $rootScope.changeDate($scope,param); 
} 

$scope.makeDesign_293212 = function(param){ 
	 $rootScope.getPatientInfoByID($scope,param);
} 

$scope.makeDesign_293473 = function(param){ 
	 $rootScope.changeDate($scope,param); 
} 
