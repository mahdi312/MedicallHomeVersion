app = angular.module("APP").controller("Ctrl190613", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$timeout){
...
$scope.makeDesign_272365 = function(param){ 
	 $rootScope.design_20199($scope,param); 
} 
