app = angular.module("APP").controller("Ctrl190536", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_282644 = function(param){ 
	 $rootScope.DD_goToChangeProgram($scope,param); 
} 
