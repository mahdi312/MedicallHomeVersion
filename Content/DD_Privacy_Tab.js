app = angular.module("APP").controller("CtrlDD_Privacy_Tab", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272525 = function(param){ 
	 $rootScope.doctorEditPrivacy($scope,param);
} 

$scope.makeDesign_293390 = function(param){ 
