app = angular.module("APP").controller("CtrlDSU_ConfirmInfo", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$mdDialog', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$mdDialog){
...
$scope.makeDesign_272417 = function(param){ 
	 $rootScope.goToDoctorDashboard($scope,param);
} 

$scope.makeDesign_293085 = function(param){ 
	 $rootScope.getDocID($scope,param); 
} 
