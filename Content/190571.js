app = angular.module("APP").controller("Ctrl190571", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293458 = function(param){ 
	 $rootScope.getDoctorInfoById($scope,param);
} 

$scope.makeDesign_293461 = function(param){ 
	 $rootScope.doctorEditBiography($scope,param);
} 
