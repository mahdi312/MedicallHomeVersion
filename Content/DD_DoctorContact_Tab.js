app = angular.module("APP").controller("CtrlDD_DoctorContact_Tab", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272528 = function(param){ 
	 $rootScope.doctorEditContact($scope,param);
} 

$scope.makeDesign_293465 = function(param){ 
	 $rootScope.getDoctorInfoById($scope,param);
} 

$scope.makeDesign_272527 = function(param){ 
	 $rootScope.doctorEditContact2($scope,param);
} 
