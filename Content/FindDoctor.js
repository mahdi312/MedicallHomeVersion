app = angular.module("APP").controller("CtrlFindDoctor", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
	$scope.options = [
        {
