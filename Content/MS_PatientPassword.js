app = angular.module("APP").controller("CtrlMS_PatientPassword", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272456 = function(param){ 
	 $rootScope.checkDoctorPassword($scope,param);
};

$scope.makeDesign_272372 = function(param){ 
	 $rootScope.checkPatientPassword($scope,param);
};
