app = angular.module("APP").controller("CtrlDSU_PhysicianCouncilCode", ['$rootScope', '$scope', '$http', '$q', '$filter', '$translate', '$mdToast', '$http', function ($rootScope, $scope, $http, $q, $filter, $translate, $mdToast, $http) {
    ...
    $scope.makeDesign_272390 = function (param) {
        $rootScope.doctorSignUp_MS1($scope, param);
    }
